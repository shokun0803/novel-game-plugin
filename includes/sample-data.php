...
function noveltool_get_shadow_detective_game_data() {
    ...
    // 各種背景画像（プレースホルダー）
    $bg_office = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#8B7355"/>
                <rect x="100" y="150" width="200" height="300" fill="#654321"/>
            ...
            $svg_bg_width / 2,
            $svg_bg_height / 2,
            esc_html( __( 'Detective Office', 'novel-game-plugin' ) )
        )
    );
    
    $bg_warehouse = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#2C2C2C"/>
                <rect x="50" y="100" width="300" height="400" fill="#1A1A1A"/>
                <text x="%d" y="%d" font-size="24" text-anchor="middle" fill="#FFFFFF">%s</text>
            </svg>',
            $svg_bg_width,
            $svg_bg_height,
            ...
            $svg_bg_width / 2,
            $svg_bg_height / 2,
            esc_html( __( 'Warehouse District', 'novel-game-plugin' ) )
        )
    );
    
    $bg_mansion = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#D4AF37"/>
                <rect x="200" y="200" width="400" height="300" fill="#FFD700"/>
                <text x="%d" y="%d" font-size="24" text-anchor="middle" fill="#000000">%s</text>
            </svg>',
            $svg_bg_width,
            $svg_bg_height,
            $svg_bg_width,
            ...
            $svg_bg_width / 2,
            $svg_bg_height / 2,
            esc_html( __( 'Kurosaki Mansion', 'novel-game-plugin' ) )
        )
    );
    
    $bg_cafe = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#8B4513"/>
                <circle cx="400" cy="300" r="100" fill="#D2691E"/>
                <text x="%d" y="%d" font-size="24" text-anchor="middle" fill="#FFFFFF">%s</text>
            </svg>',
            $svg_bg_width,
            $svg_bg_height,
            ...
            $svg_bg_width / 2,
            $svg_bg_height / 2,
            esc_html( __( 'Cafe', 'novel-game-plugin' ) )
        )
    );
    
    $bg_study = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#654321"/>
                <rect x="50" y="100" width="150" height="400" fill="#8B4513"/>
                <rect x="600" y="100" width="150" height="400" fill="#8B4513"/>
                <text x="%d" y="%d" font-size="24" text-anchor="middle" fill="#FFFFFF">%s</text>
            </svg>',
            $svg_bg_width,
            $svg_bg_height,
            ...
            $svg_bg_width / 2,
            $svg_bg_height / 2,
            esc_html( __( 'Study', 'novel-game-plugin' ) )
        )
    );
    
    $bg_hidden_room = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#1C1C1C"/>
                <rect x="300" y="250" width="200" height="150" fill="#3C3C3C"/>
                <text x="%d" y="%d" font-size="24" text-anchor="middle" fill="#FFFFFF">%s</text>
            </svg>',
            $svg_bg_width,
            $svg_bg_height,
            ...
            $svg_bg_width / 2,
            $svg_bg_height / 2,
            esc_html( __( 'Hidden Room', 'novel-game-plugin' ) )
        )
    );
    
    $bg_alley = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#404040"/>
                <rect x="100" y="0" width="200" height="%d" fill="#2C2C2C"/>
                <rect x="500" y="0" width="200" height="%d" fill="#2C2C2C"/>
                <text x="%d" y="%d" font-size="24" text-anchor="middle" fill="#FFFFFF">%s</text>
            </svg>',
            $svg_bg_width,
            $svg_bg_height,
            ...
            $svg_bg_width / 2,
            $svg_bg_height / 2,
            esc_html( __( 'Back Alley', 'novel-game-plugin' ) )
        )
    );
    
    $bg_yakuza_office = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#8B0000"/>
                <rect x="250" y="200" width="300" height="250" fill="#A52A2A"/>
                <text x="%d" y="%d" font-size="24" text-anchor="middle" fill="#FFFFFF">%s</text>
            </svg>',
            $svg_bg_width,
            $svg_bg_height,
            ...
            $svg_bg_width / 2,
            $svg_bg_height / 2,
            esc_html( __( 'Ryu-gumi Office', 'novel-game-plugin' ) )
        )
    );
    
    $bg_construction = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#708090"/>
                <rect x="150" y="150" width="500" height="350" fill="#A9A9A9"/>
                <text x="%d" y="%d" font-size="24" text-anchor="middle" fill="#000000">%s</text>
            </svg>',
            $svg_bg_width,
            $svg_bg_height,
            ...
            $svg_bg_width / 2,
            $svg_bg_height / 2,
            esc_html( __( 'Takagi Construction', 'novel-game-plugin' ) )
        )
    );
    
    $bg_villa = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#228B22"/>
                <rect x="250" y="200" width="300" height="250" fill="#DEB887"/>
                <text x="%d" y="%d" font-size="24" text-anchor="middle" fill="#FFFFFF">%s</text>
            </svg>',
            $svg_bg_width,
            $svg_bg_height,
            ...
            $svg_bg_width / 2,
            $svg_bg_height / 2,
            esc_html( __( 'Villa', 'novel-game-plugin' ) )
        )
    );
    ...
    $char_client = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#FFE4E1"/>
                <circle cx="%d" cy="100" r="50" fill="#FFDAB9"/>
                <rect x="75" y="160" width="150" height="200" fill="#FF69B4" rx="20"/>
                <text x="%d" y="380" font-size="14" text-anchor="middle" fill="#000000">%s</text>
            </svg>',
            $svg_char_width,
            $svg_char_height,
            $svg_char_width,
            ...
            $svg_char_width / 2,
            $svg_char_width / 2,
            esc_html( __( 'Misaki', 'novel-game-plugin' ) )
        )
    );
    
    $char_friend = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#E0E0E0"/>
                <circle cx="%d" cy="100" r="50" fill="#D2B48C"/>
                <rect x="75" y="160" width="150" height="200" fill="#4682B4" rx="20"/>
                <text x="%d" y="380" font-size="14" text-anchor="middle" fill="#000000">%s</text>
            </svg>',
            $svg_char_width,
            $svg_char_height,
            ...
            $svg_char_width / 2,
            $svg_char_width / 2,
            esc_html( __( 'Sato', 'novel-game-plugin' ) )
        )
    );
    
    $char_informant = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#696969"/>
                <circle cx="%d" cy="100" r="50" fill="#A9A9A9"/>
                <rect x="75" y="160" width="150" height="200" fill="#2F4F4F" rx="20"/>
            ...
            $svg_char_width / 2,
            $svg_char_width / 2,
            esc_html( __( 'Informant', 'novel-game-plugin' ) )
        )
    );
    
    $char_yakuza = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#8B0000"/>
                <circle cx="%d" cy="100" r="50" fill="#CD5C5C"/>
                <rect x="75" y="160" width="150" height="200" fill="#000000" rx="20"/>
                <text x="%d" y="380" font-size="14" text-anchor="middle" fill="#FFFFFF">%s</text>
            </svg>',
            $svg_char_width,
            $svg_char_height,
            ...
            $svg_char_width / 2,
            $svg_char_width / 2,
            esc_html( __( 'Ryu-gumi Executive', 'novel-game-plugin' ) )
        )
    );
    
    $char_takagi = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#708090"/>
                <circle cx="%d" cy="100" r="50" fill="#DCDCDC"/>
                <rect x="75" y="160" width="150" height="200" fill="#696969" rx="20"/>
                <text x="%d" y="380" font-size="14" text-anchor="middle" fill="#FFFFFF">%s</text>
            </svg>',
            $svg_char_width,
            $svg_char_height,
            ...
            $svg_char_width / 2,
            $svg_char_width / 2,
            esc_html( __( 'President Takagi', 'novel-game-plugin' ) )
        )
    );
    
    $char_kurosaki = 'data:image/svg+xml;base64,' . base64_encode(
        sprintf(
            '<svg width="%d" height="%d" xmlns="http://www.w3.org/2000/svg">
                <rect width="%d" height="%d" fill="#F5F5DC"/>
                <circle cx="%d" cy="100" r="50" fill="#DEB887"/>
            ...
            $svg_char_width / 2,
            $svg_char_width / 2,
            esc_html( __( 'Makoto Kurosaki', 'novel-game-plugin' ) )
        )
    );
