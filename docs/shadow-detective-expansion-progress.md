...
> **注記（2026-07-16）:** このドキュメントは v1 シナリオ（23シーン版）の拡張検討時の記録です。
> 現在のサンプルゲームは推理フェーズ制の v2 シナリオ（25シーン）に全面改稿されており、
> 最新の設計は [shadow-detective-scenario.md](shadow-detective-scenario.md) を参照してください。
