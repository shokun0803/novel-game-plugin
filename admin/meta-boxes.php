...
function noveltool_meta_box_callback( $post ) {
    ...
    $js_strings = array(
        ...
        'normalDisplay'            => esc_html__( 'Normal Display', 'novel-game-plugin' ),
        'hiddenByCondition'        => esc_html__( 'Hidden When Condition Met', 'novel-game-plugin' ),
        ...
        'alternativeTextLabel'     => esc_html__( 'Alternative Text (when condition is met):', 'novel-game-plugin' ),
