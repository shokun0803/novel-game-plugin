...
function noveltool_meta_box_callback( $post ) {
    ...
    $js_strings = array(
        ...
        'dialoguePlaceholder'      => __( 'セリフを入力してください', 'novel-game-plugin' ),
        'speaker'                  => __( '話者:', 'novel-game-plugin' ),
        'selectSpeaker'            => __( '-- 話者を選択 --', 'novel-game-plugin' ),
        'leftCharacter'            => __( '左キャラクター', 'novel-game-plugin' ),
        'centerCharacter'          => __( '中央キャラクター', 'novel-game-plugin' ),
        'rightCharacter'           => __( '右キャラクター', 'novel-game-plugin' ),
        'narrator'                 => __( 'ナレーター', 'novel-game-plugin' ),
        'backgroundImage'          => __( '背景画像:', 'novel-game-plugin' ),
        'selectBackgroundImage'    => __( '背景画像を選択', 'novel-game-plugin' ),
        'flagControl'              => __( 'フラグ制御:', 'novel-game-plugin' ),
        'displayControl'           => __( '表示制御:', 'novel-game-plugin' ),
        'normalDisplay'            => __( '通常表示', 'novel-game-plugin' ),
        'hiddenByCondition'        => __( '条件で非表示', 'novel-game-plugin' ),
        'alternativeByCondition'   => __( '条件で内容変更', 'novel-game-plugin' ),
        'selectFlag'               => __( '-- フラグ選択 --', 'novel-game-plugin' ),
        'flagLabel'                => __( 'フラグ', 'novel-game-plugin' ),
        'condition'                => __( '条件:', 'novel-game-plugin' ),
        'conditionAnd'             => __( 'AND（すべて）', 'novel-game-plugin' ),
        'conditionOr'              => __( 'OR（いずれか）', 'novel-game-plugin' ),
        'dialogue'                 => __( 'セリフ', 'novel-game-plugin' ),
        'minDialogueRequired'      => __( '最低1つのセリフは必要です。', 'novel-game-plugin' ),
        'confirmDeleteDialogue'    => __( '本当にこのセリフを削除しますか？', 'novel-game-plugin' ),
        'mediaLibraryUnavailable'  => __( 'メディアライブラリが利用できません。', 'novel-game-plugin' ),
        'selectCharacterImage'     => __( 'キャラクター画像を選択', 'novel-game-plugin' ),
        'noFlags'                  => __( 'フラグなし', 'novel-game-plugin' ),
        'flagSettingChange'        => __( 'フラグ設定変更:', 'novel-game-plugin' ),
        'doNotSet'                 => __( '設定しない', 'novel-game-plugin' ),
        'defaultDoNotSet'          => __( 'デフォルトは「設定しない」', 'novel-game-plugin' ),
        'deleteTarget'             => __( '削除対象:', 'novel-game-plugin' ),
        'lastChoiceWarning'        => __( '注意: これは最後の選択肢です。削除すると選択肢が無くなります。', 'novel-game-plugin' ),
        'allChoicesDeleted'        => __( '選択肢が全て削除されました。', 'novel-game-plugin' ),
        ...
        'edit'                     => __( '編集', 'novel-game-plugin' ),
        'unsupportedFileExtension' => __( 'サポートされていないファイル形式です。jpg, jpeg, png, gif, webp のみアップロード可能です。', 'novel-game-plugin' ),
        'unsupportedMimeType'      => __( 'サポートされていないファイル形式です。画像ファイルのみアップロード可能です。', 'novel-game-plugin' ),
        'fileSizeExceeded'         => __( 'ファイルサイズが大きすぎます。5MB以下のファイルをアップロードしてください。', 'novel-game-plugin' ),
    );
