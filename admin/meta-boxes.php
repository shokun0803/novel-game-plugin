...
function noveltool_meta_box_callback( $post ) {
    ...
    // JavaScript用の翻訳文字列
    $js_strings = array(
        'selectOption'             => __( '-- 選択 --', 'noveltool' ),
        'createNew'                => __( '+ 新規作成...', 'noveltool' ),
        'remove'                   => __( '削除', 'noveltool' ),
        'selectImage'              => __( '画像を選択', 'noveltool' ),
        'useThisImage'             => __( 'この画像を使う', 'noveltool' ),
        'confirmDelete'            => __( '本当に削除しますか？', 'noveltool' ),
        'createFailed'             => __( '作成に失敗しました。', 'noveltool' ),
        'selectTitle'              => __( '新しいシーンのタイトルを入力してください', 'noveltool' ),
        'selectNextTitle'          => __( '次のコマンドのタイトルを入力してください', 'noveltool' ),
        'redirectingMessage'       => __( '作成中です...', 'noveltool' ),
        'dialoguePlaceholder'      => __( 'セリフを入力してください', 'noveltool' ),
        'speaker'                  => __( '話者:', 'noveltool' ),
        'selectSpeaker'            => __( '-- 話者を選択 --', 'noveltool' ),
        'leftCharacter'            => __( '左キャラクター', 'noveltool' ),
        'centerCharacter'          => __( '中央キャラクター', 'noveltool' ),
        'rightCharacter'           => __( '右キャラクター', 'noveltool' ),
        'narrator'                 => __( 'ナレーター', 'noveltool' ),
        'backgroundImage'          => __( '背景画像:', 'noveltool' ),
        'selectBackgroundImage'    => __( '背景画像を選択', 'noveltool' ),
        'flagControl'              => __( 'フラグ制御:', 'noveltool' ),
        'displayControl'           => __( '表示制御:', 'noveltool' ),
        'normalDisplay'            => __( '通常表示', 'noveltool' ),
        'hiddenByCondition'        => __( '条件で非表示', 'noveltool' ),
        'alternativeByCondition'   => __( '条件で内容変更', 'noveltool' ),
        'selectFlag'               => __( '-- フラグ選択 --', 'noveltool' ),
        'flagLabel'                => __( 'フラグ', 'noveltool' ),
        'condition'                => __( '条件:', 'noveltool' ),
        'conditionAnd'             => __( 'AND（すべて）', 'noveltool' ),
        'conditionOr'              => __( 'OR（いずれか）', 'noveltool' ),
        'dialogue'                 => __( 'セリフ', 'noveltool' ),
        'minDialogueRequired'      => __( '最低1つのセリフは必要です。', 'noveltool' ),
        'confirmDeleteDialogue'    => __( '本当にこのセリフを削除しますか？', 'noveltool' ),
        'mediaLibraryUnavailable'  => __( 'メディアライブラリが利用できません。', 'noveltool' ),
        'selectCharacterImage'     => __( 'キャラクター画像を選択', 'noveltool' ),
        'noFlags'                  => __( 'フラグなし', 'noveltool' ),
        'flagSettingChange'        => __( 'フラグ設定変更:', 'noveltool' ),
        'doNotSet'                 => __( '設定しない', 'noveltool' ),
        'defaultDoNotSet'          => __( 'デフォルトは「設定しない」', 'noveltool' ),
        'deleteTarget'             => __( '削除対象:', 'noveltool' ),
        'lastChoiceWarning'        => __( '注意: これは最後の選択肢です。削除すると選択肢が無くなります。', 'noveltool' ),
        'allChoicesDeleted'        => __( '選択肢が全て削除されました。', 'noveltool' ),
        'unsavedChanges'           => __( '現在の投稿に未保存の変更があります。\n\n保存せずに編集画面を開きますか？\n\n「キャンセル」を選択すると、まず現在の投稿を保存できます。', 'noveltool' ),
        'postNotSaved'             => __( '投稿が保存されていません。保存してから新しいコマンドを作成しますか？', 'noveltool' ),
        'newSceneCreated'          => __( '新しいシーン「%s」が作成されました。編集リンクから編集できます。', 'noveltool' ),
        'edit'                     => __( '編集', 'noveltool' ),
        'unsupportedFileExtension' => __( 'サポートされていないファイル形式です。jpg, jpeg, png, gif, webp のみアップロード可能です。', 'noveltool' ),
        'unsupportedMimeType'      => __( 'サポートされていないファイル形式です。画像ファイルのみアップロード可能です。', 'noveltool' ),
        'fileSizeExceeded'         => __( 'ファイルサイズが大きすぎます。5MB以下のファイルをアップロードしてください。', 'noveltool' ),
    );
