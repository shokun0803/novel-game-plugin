...
function noveltool_meta_box_callback( $post ) {
    ...
    $js_strings = array(
        ...
        'dialoguePlaceholder'      => esc_html__( 'セリフを入力してください', 'novel-game-plugin' ),
        ...
        'unsavedChanges'           => __( '現在の投稿に未保存の変更があります。\n\n保存せずに編集画面を開きますか？\n\n「キャンセル」を選択すると、まず現在の投稿を保存できます。', 'novel-game-plugin' ),
        'postNotSaved'             => __( '投稿が保存されていません。保存してから新しいコマンドを作成しますか？', 'novel-game-plugin' ),
        'newSceneCreated'          => __( '新しいシーン「%s」が作成されました。編集リンクから編集できます。', 'novel-game-plugin' ),
